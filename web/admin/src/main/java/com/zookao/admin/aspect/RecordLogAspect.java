...
import com.zookao.service.SpringContextBeanService;
...
public class RecordLogAspect extends AbstractAspectManager {
    ...
    private void logHandle(ProceedingJoinPoint joinPoint, Method method, Log log, String actionLog, long startTime, boolean isException, StackTraceElement[] stackTrace) {
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i] instanceof JSONObject) {
                ...
                operationLog.setArgs(parse.toString());
        ...
        if (isJoint) {
            ...
            operationLog.setArgs(sb.deleteCharAt(sb.length() - 1).toString());
        }
